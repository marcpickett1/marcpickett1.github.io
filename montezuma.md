...
![]({{ site.url }}/assets/montezuma1.gif "Just before the score flips back to zero."){:width="300"}
![]({{ site.url }}/assets/montezuma2.gif "Just after the score flips back to zero."){:width="300"}

[Raw source](montezuma.py).  This runs on Python 2.7 and requires pygame, numpy, and OpenAI gym
with Atari enabled.
